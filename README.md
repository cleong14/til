...
- [Best Temperature and Top_p Settings for Coding Tasks](./ai/best-temperature-settings-for-coding-tasks.md)
- [LLM Quantisation Methods](./ai/llm-quantisation-methods.md)
- [Phind - AI Search for Programmers](./ai/phind-ai-search-for-programmers.md)
...
- [UPT — Universal Package-management Tool](./command-line/upt-universal-package-management-tool.md)
...
- [JSON Unmarshalled Output - Println vs Printf](./go/json-unmarshalled-output-println-vs-printf.md)
